...
class BDD{
  ...
  /* Insertion candidat en fonction id_adresse_ip */
  public function insertCandidatSelonIdadresseIp($ip, $nom, $prenom, $mail, $tel, $tel_portable, $adresse, $ville, $code_postal, $date_naissance,
